...
export default function Navbar() {
  ...
  return (
    <nav className="relative bg-gray-two text-white">
      <div className="md:w-11/12 max-w-7xl mx-auto flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <Link to="/add-streamer" className="hover:text-gray-400">
            Add Streamer
          </Link>
        </div>
        ...
        >
          <span
            className={`block absolute w-full h-px bg-white transition-transform duration-300 ${
